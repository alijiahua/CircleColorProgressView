...
public class ColorCircleProgressView extends View {
    ...
    public ColorCircleProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        int color_01 = getResources().getColor(R.color.home01);
        int color_02 = getResources().getColor(R.color.home02);
        int color_03 = getResources().getColor(R.color.home03);
        int color_04 = getResources().getColor(R.color.home04);
        int color_05 = getResources().getColor(R.color.home05);
        int color_06 = getResources().getColor(R.color.home06);
        int color_07 = getResources().getColor(R.color.home07);
